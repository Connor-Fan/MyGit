===========================================================================
Tool version 2.5.3, Python package 3.8.10
...
Command:
AutoStress.exe --cleanup No --setup --auto --standby 3 60 --hibernate 3 60 --wb 3 --cb 3 60 --delay 90
AutoStress.exe --cleanup No --setup --auto --standby 500 60 --delay 90
AutoStress.exe --cleanup No --setup --auto --hibernate 500 60 --delay 90
AutoStress.exe --cleanup No --setup --auto --wb 500 --delay 90
AutoStress.exe --cleanup No --setup --auto --cb 500 60 --delay 90
AutoStress.exe --cleanup No --setup --auto --greset 500 --delay 90

Command for --stop usage:
AutoStress.exe --cleanup No --setup --auto --cb 500 60 --delay 90 --stop all
AutoStress.exe --cleanup No --setup --auto --cb 500 60 --delay 90 --stop "Cirrus Logic" "SoundWire Speakers"
