===========================================================================
Tool version 1.9.0, Python pakage 3.8.10, Product version 22621.2134
...
Command:
AutoStress.exe --cleanup No --setup --auto --standby 3 60 --hibernate 3 60 --wb 3 --cb 3 120 --delay 65
...
AutoStress.exe --cleanup No --setup --auto --standby 500 60 --delay 65 --stop all
AutoStress.exe --cleanup No --setup --auto --standby 500 60 --delay 65 --stop SanDisk
